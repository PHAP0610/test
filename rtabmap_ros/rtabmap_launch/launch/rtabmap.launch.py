...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value='/home/ic/Downloads/rtabmap_1.ini.tmp',                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='/camera/camera/rgbd', description=''),
