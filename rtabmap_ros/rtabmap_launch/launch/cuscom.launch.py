    ...
    return [
        ...
        Node(
            ...
            parameters=[{
                ...
                "subscribe_scan_cloud": PythonExpression(["'", LaunchConfiguration('subscribe_scan_cloud'), "' == 'true'"]),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('namespace',      default_value='bbmap',            description=''),
        DeclareLaunchArgument('database_path',  default_value='/home/tao/maps/map_v3_office.db',  description='Where is the map saved/loaded.'),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/cloud', description=''),
